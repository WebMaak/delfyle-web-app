  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Trademark Objection</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely trademark objection with Delfyle's expert assistance. We handle all compliance requirements, including trademark objection, return filing, and compliance monitoring."
          buttonText="Get Trademark Objection Help"
          />

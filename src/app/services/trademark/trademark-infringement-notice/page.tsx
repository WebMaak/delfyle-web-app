  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span className={styles.coloredplc}>Trademark Infringement Notice </span><span className={styles.coloredreg}>Services Online</span> <span style={{letterSpacing: 'normal'}}> in India  with</span> <span className={styles.colored}>Delfyle</span></>}
          description="Delfyle offers comprehensive support for obtaining a Trademark Infringement Notice. Our experts guide you through the entire process, ensuring compliance with all requirements, including trademark registration, trademark objection, trademark certificate issuance, trademark opposition, trademark hearing, trademark rectification, trademark infringement notice, trademark renewal, trademark restoration, trademark transfer, expedited trademark registration, logo design + trademark protection, design registration, design objection, copyright registration, and copyright objections."
          />
          ...
          <ListComponentTwo
            title="When to Send a Trademark Infringement Notice?"
            description="A legal notice should be sent when:"
            listItems={[
              "Someone uses your registered trademark without consent.",
              "The infringing mark causes market confusion.",
              "The infringer operates in the same product/service class.",
              "The infringing mark is used publicly on packaging, ads, or websites.",
              "The similarity is substantial, even if not identical.",
            ]}
          />

  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Trademark Infringement Notice</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely trademark infringement notice with Delfyle's expert assistance. We handle all compliance requirements, including trademark infringement notice, return filing, and compliance monitoring."
          buttonText="Get Trademark Infringement Notice Help"
          />

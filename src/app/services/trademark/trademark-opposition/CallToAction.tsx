  ...
  return (
    <section className="bg-white from-pink-100 via-purple-100 to-white py-16 px-6 text-center md:px-20">
      <h2 className="md:text-[3.5rem] text-[2.5rem] font-bold text-gray-800 leading-tight mb-4 text-left md:text-center">
        Trademark Registration with Delfyle Today
      </h2>
      <p className="text-gray-600 max-w-2xl mx-auto mb-8 text-lg text-left md:text-center">
        Ensure your trust, society, or institution remains compliant with the Income Tax Act by choosing Delfyle’s Trademark Registration Services. Contact us now for expert assistance and let us help you file your return safely, accurately, and on time.
      </p>
      <p className="text-gray-600 max-w-2xl mx-auto mb-8 text-lg text-left md:text-center">

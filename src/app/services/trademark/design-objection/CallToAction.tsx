  ...
  return (
   <section className="bg-white from-pink-100 via-purple-100 to-white py-16 px-6 text-center md:px-20">
    ...
    <h2 className="text-xl font-bold text-gray-800 leading-tight mb-4 text-left md:text-center">
      Overcome Design Objections & Secure Your Intellectual Property
    </h2>
    <p className="text-gray-600 max-w-4xl mx-auto mb-6 text-lg text-left md:text-center">
      Ready to tackle design objections efficiently? Delfyle ensures your design registration process is smooth, compliant, and stress-free.
    </p>
    <p className="text-gray-600 max-w-4xl mx-auto mb-8 text-lg text-left md:text-center">
      Contact our experts today to receive guided support in responding to objections, managing deadlines, and securing your design rights.
    </p>
    <div className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      >
        Resolve Your Design Objections Now
      </a>
      <a
        href="/contact"
    ...
    <p className="text-gray-600 mt-10 max-w-4xl mx-auto mb-8 text-lg text-left md:text-center italic">
      Design Registration Online with Delfyle — Expert Support You Can Trust.
    </p>
  </section>

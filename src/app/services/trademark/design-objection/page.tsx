  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Design Objection</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely design objection with Delfyle's expert assistance. We handle all compliance requirements, including design objection, return filing, and compliance monitoring."
          buttonText="Get Design Objection Help"
          />

      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero
            heading={
              <>
                <span className={styles.coloredplc}>Design Objection</span>
                <span className={styles.coloredreg}>Handling & Resolution</span>
                <span style={{ letterSpacing: 'normal' }}> in India with</span>
                <span className={styles.colored}>Delfyle</span>
              </>
            }
            description="During design registration, examiners may raise objections regarding originality, clarity, or compliance. Delfyle helps you respond accurately and secure your design rights efficiently."
          />

  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Trademark Hearing</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely trademark hearing with Delfyle's expert assistance. We handle all compliance requirements, including trademark hearing, return filing, and compliance monitoring."
          buttonText="Get Trademark Hearing Help"
          />

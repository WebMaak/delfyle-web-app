  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Trademark Rectification</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely trademark rectification with Delfyle's expert assistance. We handle all compliance requirements, including trademark rectification, return filing, and compliance monitoring."
          buttonText="Get Trademark Rectification Help"
          />

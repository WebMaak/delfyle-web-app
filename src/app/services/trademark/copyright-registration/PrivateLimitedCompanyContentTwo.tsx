    ...
    <div ref={leftColumnRef} className={styles.leftColumn}>
      ...
      <div ref={leftBottomContainerRef} className={styles.leftBottomContainer}>
        <p ref={(el) => { if (el) leftBottomContentRef.current[1] = el; }} className={styles.paragraphContent} style={{ marginBottom: '10px' }}>
          Copyright registration in India provides legal protection for creators, ensuring exclusive rights over their literary, artistic, musical, and digital works. At Delfyle, we simplify the process, guiding you from filing to certificate issuance.
        </p>
        ...
        <p className={styles.paragraphContent}>
          Once your work is registered, you can use the copyright symbol (©) to publicly indicate protection, deterring potential infringers and reinforcing your legal rights.
        </p>
    ...
    <div ref={rightColumnRef} className={styles.rightColumn}>
      <div ref={el => { if (el) rightColumnContentRef.current[0] = el }} className={styles.rightTopContainer}>
        <p className={styles.rightDescription}>
          Delfyle provides professional support for copyright registration, ensuring your creative works are legally protected and your rights are fully enforceable.
        </p>
      </div>

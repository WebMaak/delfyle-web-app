...
const CallToAction = () => {
  ...
  <h2 className="text-xl font-bold text-gray-800 leading-tight mb-4 text-left md:text-center">
    Protect Your Creative Works & Secure Your Copyright
  </h2>
  <p className="text-gray-600 max-w-4xl mx-auto mb-6 text-lg text-left md:text-center">
    Ready to secure your intellectual property? Delfyle simplifies the online copyright registration process, ensuring your works are legally protected efficiently.
  </p>
  <p className="text-gray-600 max-w-4xl mx-auto mb-8 text-lg text-left md:text-center">
    Our experts guide you through application filing, documentation, objection handling, and timely certificate issuance, making copyright registration hassle-free.
  </p>
  ...
  <p className="text-gray-600 mt-10 max-w-4xl mx-auto mb-8 text-lg text-left md:text-center italic">
    Copyright Registration Online with Delfyle — Expert Guidance You Can Rely On.
  </p>
</section>

  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Trademark Renewal</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely trademark renewal with Delfyle's expert assistance. We handle all compliance requirements, including trademark renewal, return filing, and compliance monitoring."
          buttonText="Get Trademark Renewal Help"
          />

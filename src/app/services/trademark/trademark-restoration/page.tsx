  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span className={styles.coloredplc}>Trademark Restoration </span><span className={styles.coloredreg}>Services Online</span> <span style={{letterSpacing: 'normal'}}> in India  with</span> <span className={styles.colored}>Delfyle</span></>}
          description="Delfyle provides a seamless trademark restoration process in India, ensuring your brand's protection and exclusivity. Our team of experts will guide you through the restoration process, ensuring all legal requirements are met, including documentation, filing, and follow-up with the Trademark Office. With Delfyle, you can rest assured that your trademark rights are protected and your brand's integrity is maintained."
          />

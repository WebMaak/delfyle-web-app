  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Copyright Objections</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely copyright objections with Delfyle's expert assistance. We handle all compliance requirements, including copyright objections, return filing, and compliance monitoring."
          buttonText="Get Copyright Objections Help"
          />

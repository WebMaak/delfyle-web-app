    ...
    <div className={styles.mainContentWrapper}>
      <div ref={leftColumnRef} className={styles.leftColumn}>
        ...
        <div ref={leftBottomContainerRef} className={styles.leftBottomContainer}>
          <h3 ref={el => { if (el) leftBottomContentRef.current[0] = el }} className={styles.subContentHeading}>Online ITR-3 Filing (Recommended):</h3>
          ...
          <h3 ref={el => { if (el) leftBottomContentRef.current[2] = el }} className={styles.subContentHeading} style={{display: 'none'}}>How does Delfyle assist taxpayers with ITR-3 filing?</h3>
          <p ref={el => { if (el) leftBottomContentRef.current[3] = el }} className={styles.paragraphContent} style={{display: 'none'}}>
          At Delfyle, we provide expert-assisted ITR-3 filing services, making tax filing stress-free, secure, and efficient. Whether you're an NRI, salaried individual with capital gains, or a director in a company, Delfyle ensures accurate filing and complete compliance.
          </p>
  
          <h3 ref={el => { if (el) leftBottomContentRef.current[4] = el }} className={styles.subContentHeading}>Online ITR-3 Filing (Recommended):</h3>
          ...
          <h3 ref={el => { if (el) leftBottomContentRef.current[4] = el }} className={styles.subContentHeading}>Offline ITR-3 Filing (Only for Age 80+):</h3>
          <div ref={el => { if (el) leftBottomContentRef.current[5] = el }} className={styles.productsGrid} style={{display: 'flex', flexDirection: 'column'}}>
            <ul className={styles.productsList}>
          ...
          <h3 ref={el => { if (el) leftBottomContentRef.current[4] = el }} className={styles.subContentHeading}> Late Filing Penalties for ITR-3</h3>
          <div ref={el => { if (el) leftBottomContentRef.current[5] = el }} className={styles.productsGrid} style={{display: 'flex', flexDirection: 'column'}}>
            <ul className={styles.productsList}>
      ...
      <div ref={rightColumnRef} className={styles.rightColumn}>
        <div ref={el => { if (el) rightColumnContentRef.current[0] = el }} className={styles.rightTopContainer}>
          <p className={styles.rightDescription}>
            Delfyle offers secure, expert-assisted ITR-3 filing for residents, NRIs, and high-net-worth individuals. We ensure compliance, optimize deductions, and file your returns on time—stress-free.
          </p>
        </div>

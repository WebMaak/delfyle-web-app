  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero
          heading={<><span>15CA & 15CB Filing</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely 15CA & 15CB returns with Delfyle's expert assistance. We handle all compliance requirements, including 15CA & 15CB registration, return filing, and compliance monitoring."
          buttonText="Get 15CA & 15CB Filing Help"
          />

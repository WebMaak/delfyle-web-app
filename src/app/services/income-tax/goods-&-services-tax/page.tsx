  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero
          heading={<><span>Goods & Services Tax</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely GST returns with Delfyle's expert assistance. We handle all compliance requirements, including GST registration, return filing, and compliance monitoring."
          buttonText="Get Goods & Services Tax Help"
          />

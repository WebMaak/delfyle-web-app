  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>ITR 2 Return Filing</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely ITR 2 returns with Delfyle's expert assistance. We handle all compliance requirements, including ITR 2 registration, return filing, and compliance monitoring."
          buttonText="Get ITR 2 Return Filing Help"
          />

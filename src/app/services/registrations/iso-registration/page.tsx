  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        ...
        <CustomAccordion
          subheading="ISO Registration Process"
          title="Step-by-Step Guide to Obtain Your ISO Certification"
          description="Follow these structured steps with Delfyle to achieve ISO certification, ensuring compliance, quality management, and a smooth approval process:"
          items={[
            {
              id: 'iso-step-1',
              title: 'Documentation Support',
              content: 'We assist with preparing policies, manuals, procedures, and all required documentation for ISO certification.',
              stepNumber: 1
            },
            {
              id: 'iso-step-2',
              title: 'Audit Preparation',
              content: 'Our specialists prepare your business for certification body inspections to ensure compliance and readiness.',
              stepNumber: 2
            },
            {
              id: 'iso-step-3',
              title: 'Accurate Online Application',
              content: 'We help you submit a correct and complete ISO certification application online for faster processing.',
              stepNumber: 3
            },
            {
              id: 'iso-step-4',
              title: 'Expert Advisory',
              content: 'Get guidance on ISO standard selection, implementation strategies, and aligning business processes with standards.',
              stepNumber: 4
            },
            {
              id: 'iso-step-5',
              title: 'End-to-End Service',
              content: 'From document review to post-certification support, Delfyle handles every step of your ISO registration journey.',
              stepNumber: 5
            },
            {
              id: 'iso-step-6',
              title: 'Improved Business Readiness',
              content: 'Enhance internal systems and operational efficiency, ensuring sustainable growth and global recognition.',
              stepNumber: 6
            }
          ]}
          variant="numbered"
        ...
        <CallToAction
          heading="Get Your ICEGATE Registration"
          highlighted="Fast, Simple & Worry-Free"
          subheading="Delfyle helps you register on ICEGATE quickly and accurately, ensuring seamless import/export operations."
          cards={[
            {
              icon: <FaUserTie className="text-2xl" />,
              title: "Expert Guidance",
              description: "We guide you through eligibility, required documents, and portal registration for ICEGATE.",
            },
            {
              icon: <FaFileAlt className="text-2xl" />,
              title: "Accurate Application Filing",
              description: "Ensure correct submission of your details for quick approval and smooth access to customs services.",
            },
            {
              icon: <FaBolt className="text-2xl" />,
              title: "Post-Registration Support",
              description: "Get assistance with portal login, transaction types, and managing customs filings efficiently.",
            },
          ]}

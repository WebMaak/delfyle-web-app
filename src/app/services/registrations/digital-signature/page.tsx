    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        ...
        <StartupHero
          heading={
            <>
              <span className={styles.coloredplc}>Digital</span>
              <span className={styles.coloredreg}> Signature & Compliance</span>
              <span style={{ letterSpacing: 'normal' }}> with </span>
              <span className={styles.colored}>Delfyle</span>
            </>
          }
          description="Secure your digital identity with a hassle-free Digital Signature Certificate (DSC) application through Delfyle. Our experts guide you through every step, from online video verification to the delivery of your secure USB token, ensuring you can sign documents and file with government portals confidently."
        />
          ...
          <CallToAction
            heading="Get Your Digital Signature Certificate"
            highlighted="Secure Your Digital Transactions"
            subheading="Our team provides end-to-end assistance, from document verification to securing your legally valid DSC, ensuring a smooth and hassle-free application process."
            cards={[
              {
                icon: <FaUserTie className="text-2xl" />,
                title: "Document Verification",
                description: "We help you verify your identity and documents (PAN, Aadhaar) and ensure they meet the requirements for DSC issuance by the Certifying Authority.",
              },
              {
                icon: <FaFileAlt className="text-2xl" />,
                title: "Online Application & Video KYC",
                description: "Our team handles the online application submission and guides you through the simple video verification process for fast approval.",
              },
              {
                icon: <FaBolt className="text-2xl" />,
                title: "DSC Issuance & Token Delivery",
                description: "We track your application and ensure your Digital Signature Certificate is issued promptly, with the secure USB token delivered right to your doorstep.",
              },
            ]}

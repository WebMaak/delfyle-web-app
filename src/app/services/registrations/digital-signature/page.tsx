  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Digital Signature</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely digital signature with Delfyle's expert assistance. We handle all compliance requirements, including digital signature, return filing, and compliance monitoring."
          buttonText="Get Digital Signature Help"
          />

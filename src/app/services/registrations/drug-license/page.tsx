  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Drug License</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely drug license with Delfyle's expert assistance. We handle all compliance requirements, including drug license, return filing, and compliance monitoring."
          buttonText="Get Drug License Help"
          />

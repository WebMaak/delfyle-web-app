    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        ...
        <StartupHero
          heading={
            <>
              <span className={styles.coloredplc}>Drug License</span>
          ...
          description="Simplify your drug license registration with Delfyle. We guide you through every step, from document preparation to official inspections, ensuring your business gains legal compliance."
        />
          ...
          <CallToAction
            heading="Obtain Your Drug License Today"
            highlighted="Secure Your Pharmaceutical Business"
            subheading="Our team provides end-to-end assistance for your drug license application, from document preparation to navigating inspections, ensuring a smooth and hassle-free registration process."
            cards={[
              {
                icon: <FaUserTie className="text-2xl" />,
                title: "Documentation",
                description: "We help compile all required documents, including affidavits and premises details, for a seamless application.",
              },
              {
                icon: <FaFileAlt className="text-2xl" />,
                title: "Submission",
                description: "Our team accurately prepares and submits your application on the official state portal, ensuring all details are correctly filed.",
              },
              {
                icon: <FaBolt className="text-2xl" />,
                title: "Issuance",
                description: "We guide you through the inspection process and track your application until you successfully receive your drug license.",
              },
            ]}
          ...
          <CallToAction
            heading="Obtain Your Drug License Today"
            highlighted="Secure Your Pharmaceutical Business"
            subheading="Our team provides complete end-to-end assistance for your drug license application, from preparing documents to navigating inspections, ensuring a smooth and hassle-free registration process."
            cards={[
              {
                icon: <FaUserTie className="text-2xl" />,
                title: "Document Preparation",
                description: "We help you compile all required documents, including affidavits, qualification certificates, and premises details, for a seamless application.",
              },
              {
                icon: <FaFileAlt className="text-2xl" />,

  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>WB RERA Registration</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely WB RERA registration with Delfyle's expert assistance. We handle all compliance requirements, including WB RERA registration, return filing, and compliance monitoring."
          buttonText="Get WB RERA Registration Help"
          />

    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        ...
        <StartupHero
          heading={
            <>
              <span className={styles.coloredplc}>WB RERA</span>
          ...
          description="Secure your WB RERA registration effortlessly with Delfyle. Our experts guide you through eligibility checks, document preparation, online application, and certificate issuance, ensuring your real estate project complies with all regulations and builds trust with buyers."
        />
          ...
          <CallToAction
            heading="Need WB RERA Registration for Your Project?"
            highlighted="Ensure Compliance & Build Buyer Trust"
            subheading="Our team provides complete end-to-end assistance, from checking project eligibility to obtaining your WB RERA registration, ensuring a smooth and hassle-free process."
            cards={[
              {
                icon: <FaUserTie className="text-2xl" />,
                title: "Eligibility & Documentation",
                description: "We guide you through the eligibility criteria for RERA and help you compile all required project and promoter documents.",
              },
              {
                icon: <FaFileAlt className="text-2xl" />,
                title: "Application Submission",
                description: "Our team accurately prepares and submits your WB RERA application to the relevant authorities, ensuring all details are correct.",
              },
              {
                icon: <FaBolt className="text-2xl" />,
                title: "Certificate Issuance & Compliance",
                description: "We track your application until you receive the RERA registration number and assist with ongoing project compliance filings.",
              },
            ]}

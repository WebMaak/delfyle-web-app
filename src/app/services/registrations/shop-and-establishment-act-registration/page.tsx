  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Shop & Establishment Act Registration</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely shop & establishment act registration with Delfyle's expert assistance. We handle all compliance requirements, including shop & establishment act registration, return filing, and compliance monitoring."
          buttonText="Get Shop & Establishment Act Registration Help"
          />

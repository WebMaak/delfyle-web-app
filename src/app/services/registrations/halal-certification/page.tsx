  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Halal Certification</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely halal certification with Delfyle's expert assistance. We handle all compliance requirements, including halal certification, return filing, and compliance monitoring."
          buttonText="Get Halal Certification Help"
          />

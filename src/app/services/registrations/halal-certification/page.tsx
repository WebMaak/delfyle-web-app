    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
       ...
       <StartupHero
        heading={
          <>
            <span className={styles.coloredplc}>Halal</span>
            <span className={styles.coloredreg}> Certification</span>
            <span style={{ letterSpacing: 'normal' }}> made easy with </span>
            <span className={styles.colored}>Delfyle</span>
          </>
        }
        description="Obtain your Halal certification quickly and confidently. Delfyle handles eligibility checks, documentation, audits, and renewals—helping your food business meet international standards, gain customer trust, and expand market reach."
      />
        ...
        <CallToAction
          heading="Get Your Halal Certification"
          highlighted="Fast, Simple & Worry-Free"
          subheading="Delfyle supports you at every step to ensure smooth Halal certification for your business."
          cards={[
            {
              icon: <FaUserTie className="text-2xl" />,
              title: "Expert Guidance",
              description: "We guide you through the certification process and help prepare all required documentation.",
            },
            {
              icon: <FaFileAlt className="text-2xl" />,
              title: "Accurate Application Filing",
              description: "Ensure correct submissions for faster approval and compliance with Halal standards.",
            },
            {
              icon: <FaBolt className="text-2xl" />,
              title: "Certification & Renewal",
              description: "Receive your Halal certificate on time and stay updated with renewal schedules.",
            },
          ]}

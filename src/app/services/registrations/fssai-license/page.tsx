    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        ...
        />
          ...
          <CustomAccordion
            subheading="FSSAI License Assistance Process"
            title="Step-by-Step Guide to Obtain Your FSSAI License"
            description="Follow these systematic steps with Delfyle to apply for your FSSAI license, ensuring compliance and a smooth approval process:"
            items={[
              {
                id: 'fssai-step-1',
                title: 'Expert Consultation',
                content: 'Our experts help you identify the correct type of FSSAI license that best fits your business needs.',
                stepNumber: 1
              },
              {
                id: 'fssai-step-2',
                title: 'Document Assistance',
                content: 'We assist in gathering, validating, and organizing all the necessary paperwork required for your application.',
                stepNumber: 2
              },
              {
                id: 'fssai-step-3',
                title: 'Accurate Filing',
                content: 'Our team prepares and files an error-free FSSAI application with the authorities to avoid delays or rejections.',
                stepNumber: 3
              },
              {
                id: 'fssai-step-4',
                title: 'Application Tracking',
                content: 'We continuously track the status of your FSSAI license application and provide you with timely updates.',
                stepNumber: 4
              },
              {
                id: 'fssai-step-5',
                title: 'Affordable Pricing',
                content: 'We offer competitive food license fees with complete transparency and no hidden charges.',
                stepNumber: 5
              },
              {
                id: 'fssai-step-6',
                title: 'Renewal Support',
                content: 'Our proactive alerts and renewal services ensure your FSSAI license remains valid without interruptions.',
                stepNumber: 6
              }
            ]}
            variant="numbered"

  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>FSSAI License</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely FSSAI license with Delfyle's expert assistance. We handle all compliance requirements, including FSSAI license, return filing, and compliance monitoring."
          buttonText="Get FSSAI License Help"
          />

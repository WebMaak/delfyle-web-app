    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        ...
        <StartupHero
          heading={
            <>
              <span className={styles.coloredplc}>FCRA</span>
          ...
          description="Simplify your FCRA registration with Delfyle. We guide you from document preparation to securing your certificate, ensuring your NGO can legally receive foreign contributions for social and charitable work."
        />
          ...
          <CallToAction
            heading="Get Your FCRA Registration"
            highlighted="Access Foreign Funds Legally"
            subheading="Our team provides complete end-to-end assistance, from preparing documents to securing your FCRA certificate, ensuring a smooth and hassle-free registration process."
            cards={[
              {
                icon: <FaUserTie className="text-2xl" />,
                title: "Document & Eligibility Assessment",
                description: "We assess your eligibility and help you prepare all required documents for a seamless application process.",
              },
              {
                icon: <FaFileAlt className="text-2xl" />,
                title: "Online Application Submission",
                description: "Our experts accurately prepare and submit your application on the official FCRA portal for timely processing.",
              },
              {
                icon: <FaBolt className="text-2xl" />,
                title: "FCRA Certificate Issuance",
                description: "We track your application until you receive your FCRA certificate, enabling you to accept foreign contributions legally.",
              },
            ]}

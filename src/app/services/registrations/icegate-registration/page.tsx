  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>ICEGATE Registration</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely ICEGATE registration with Delfyle's expert assistance. We handle all compliance requirements, including ICEGATE registration, return filing, and compliance monitoring."
          buttonText="Get ICEGATE Registration Help"
          />

    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        ...
        <StartupHero
          heading={
            <>
              <span className={styles.coloredplc}>80G</span>
          ...
          description="Boost your NGO's fundraising potential with 80G registration. Our experts guide you through every step, from eligibility checks and document preparation to online application and certificate issuance, ensuring your organization can attract more donors by offering tax benefits on their contributions."
        />
          ...
          <CallToAction
            heading="Secure 80G Registration for Your Organization"
            highlighted="Attract More Donors with Tax Benefits"
            subheading="Our team provides complete end-to-end assistance, from checking eligibility to obtaining your 80G registration, ensuring a smooth and hassle-free process."
            cards={[
              {
                icon: <FaUserTie className="text-2xl" />,
                title: "Eligibility & Documentation",
                description: "We guide you through the eligibility criteria and help you compile all required documents for a seamless application, including audited financials and activity reports.",
              },
              {
                icon: <FaFileAlt className="text-2xl" />,
                title: "Application Submission",
                description: "Our team accurately prepares and submits your application (Form 10A or 10G) to the Income Tax Department, ensuring all details are correctly filed.",
              },
              {
                icon: <FaBolt className="text-2xl" />,
                title: "Certificate Issuance & Compliance",
                description: "We track your application until you receive the 80G certificate and provide ongoing support to help you maintain compliance and renewal requirements.",
              },
            ]}

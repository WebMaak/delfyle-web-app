  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>12A & 80G Registration</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely 12A & 80G registration with Delfyle's expert assistance. We handle all compliance requirements, including 12A & 80G registration, return filing, and compliance monitoring."
          buttonText="Get 12A & 80G Registration Help"
          />

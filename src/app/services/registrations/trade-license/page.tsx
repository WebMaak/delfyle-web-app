  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Trade License</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely trade license with Delfyle's expert assistance. We handle all compliance requirements, including trade license, return filing, and compliance monitoring."
          buttonText="Get Trade License Help"
          />

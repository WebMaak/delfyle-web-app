    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        ...
        <StartupHero
          heading={
            <>
              <span className={styles.coloredplc}>Trade License</span>
          ...
          description="Obtain your trade license effortlessly with Delfyle. Our experts assist with eligibility checks, document preparation, application submission, and license issuance, ensuring your business operates legally and smoothly while avoiding penalties."
        />
          ...
          <CallToAction
            heading="Need a Trade License for Your Business?"
            highlighted="Operate Legally & Avoid Penalties"
            subheading="Our expert team provides end-to-end assistance, from checking eligibility to obtaining your trade license, ensuring a smooth and hassle-free registration process."
            cards={[
              {
                icon: <FaUserTie className="text-2xl" />,
                title: "Eligibility & Documentation",
                description: "We guide you through eligibility requirements and help gather all necessary documents for trade license application.",
              },
              {
                icon: <FaFileAlt className="text-2xl" />,
                title: "Application Submission",
                description: "Our team prepares your application correctly and submits it to the relevant municipal authority, online or offline.",
              },
              {
                icon: <FaBolt className="text-2xl" />,
                title: "License Issuance & Renewal",
                description: "We track your application and assist in obtaining the trade license, as well as guide you for timely annual renewals to stay compliant.",
              },
            ]}

    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        ...
        <StartupHero
          heading={
            <>
              <span className={styles.coloredplc}>PF</span>
          ...
          description="Get your Provident Fund (PF) registration done quickly and compliantly with Delfyle. Our experts guide you through eligibility, documentation, application, and code issuance—ensuring your business meets all EPFO requirements and your employees enjoy long-term financial security."
        />
          ...
          <CallToAction
            heading="Need PF Registration for Your Business?"
            highlighted="Stay Compliant & Support Your Employees"
            subheading="Delfyle provides complete assistance for PF registration—from eligibility checks and document collection to application submission and EPF code generation. Ensure timely compliance and safeguard your employees’ future."
            cards={[
              {
                icon: <FaUserTie className="text-2xl" />,
                title: "Eligibility & Documentation",
                description: "We help you determine PF applicability and gather all necessary documents for a smooth registration process.",
              },
              {
                icon: <FaFileAlt className="text-2xl" />,
                title: "Application Submission",
                description: "Our team prepares and submits your PF registration application accurately to the EPFO portal.",
              },
              {
                icon: <FaBolt className="text-2xl" />,
                title: "EPF Code & Ongoing Compliance",
                description: "We track your application, obtain your EPF code, and assist with monthly filings and compliance to avoid penalties.",
              },
            ]}
            primaryBtnText="Get PF Registration Help"
            primaryBtnLink="https://wa.me/917439587419"
            secondaryBtnText="Free Compliance Consultation"

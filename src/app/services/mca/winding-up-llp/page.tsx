  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Winding Up LLP</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely winding up LLP with Delfyle's expert assistance. We handle all compliance requirements, including winding up LLP, return filing, and compliance monitoring."
          buttonText="Get Winding Up LLP Help"
          />

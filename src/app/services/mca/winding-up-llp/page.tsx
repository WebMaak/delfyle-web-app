      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        <div>
          <StartupHero
            heading={
              <>
                <span className={styles.coloredplc}>LLP Winding Up</span>
                <span className={styles.coloredreg}>Service with</span>
                <span style={{ letterSpacing: 'normal' }}> </span>
                <span className={styles.colored}>Delfyle</span>
              </>
            }
            description="A legally compliant process to close your Limited Liability Partnership. From filing resolutions to liquidating assets, our experts provide end-to-end support for a hassle-free and timely dissolution."
          />
         ...
         <CallToAction
            heading="Close Your LLP with Confidence"
            highlighted="Simplify the Winding-Up Process"
            subheading="Whether it's a voluntary closure or a Tribunal-initiated process, our team handles all legal formalities and documentation to ensure a smooth and compliant dissolution."
            cards={[
              {
                icon: <FaFileCircleCheck className="text-2xl" />,
                title: "Voluntary Liquidation",
                description: "Initiate a hassle-free closure and submit a Declaration of Solvency to the Registrar.",
              },
              {
                icon: <FaHandshake className="text-2xl" />,
                title: "Statutory Compliance",
                description: "Ensure adherence to the LLP Act, 2008, and IBC, 2016, with our expert guidance.",
              },
              {
                icon: <FaRegCalendarCheck className="text-2xl" />,
                title: "End-to-End Support",
                description: "We manage all formalities, from drafting partner resolutions to coordinating with the Tribunal.",
              },
            ]}

  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Appointment of Auditor</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely appointment of auditor with Delfyle's expert assistance. We handle all compliance requirements, including appointment of auditor, return filing, and compliance monitoring."
          buttonText="Get Appointment of Auditor Help"
          />

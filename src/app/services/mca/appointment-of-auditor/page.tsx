  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        <div>
          <StartupHero
            heading={
              <>
                <span className={styles.coloredplc}>Auditor Appointment</span>
            ...
            description="Ensure your company is compliant from day one. Our expert services streamline the appointment of your first auditor and the filing of Form ADT-1, so you can focus on your business."
        />
         ...
         <CustomAccordion
          subheading="How Delfyle Can Help with ADT-1 Filing"
          title="Seamless Auditor Appointment & Compliance"
          description="Delfyle offers end-to-end assistance to ensure a smooth and accurate filing of Form ADT-1, including:"
          items={[
            {
              id: 'auditor-appt-1',
              title: 'Document Preparation',
              content: 'We help prepare all necessary documentation, such as board resolutions and auditor consent letters, in the correct format for seamless filing.',
              stepNumber: 1
            },
            {
              id: 'auditor-appt-2',
              title: 'Compliance Review',
              content: 'Our experts verify eligibility and ensure no errors in documentation to prevent rejection by the Registrar of Companies (ROC).',
              stepNumber: 2
            },
            {
              id: 'auditor-appt-3',
              title: 'MCA Filing Support',
              content: 'Delfyle can file the form directly with the Ministry of Corporate Affairs (MCA) on your behalf, handling the technical submission process.',
              stepNumber: 3
            },
            {
              id: 'auditor-appt-4',
              title: 'Deadline Monitoring',
              content: 'We keep track of all statutory deadlines to ensure timely submission of Form ADT-1 and help you avoid penalties.',
              stepNumber: 4
            },
            {
              id: 'auditor-appt-5',
              title: 'Expert Guidance',
              content: 'Get professional advice on auditor appointments and all your ongoing ROC compliance needs from our experienced team.',
              stepNumber: 5
            }
          ]}
          variant="numbered"
      ...
      />
         ...
         <CallToAction
          heading="Streamline Your Auditor Appointment"
          highlighted="Stay Compliant with ADT-1 Filing"
          subheading="Don't risk penalties for non-compliance. We ensure the timely and accurate filing of Form ADT-1, whether for a new company or a yearly appointment."
          cards={[
            {
              icon: <FaFileCircleCheck className="text-2xl" />,
              title: "Expert ADT-1 Filing",
              description: "We handle the entire process, from preparing the board resolution to filing Form ADT-1 with the Ministry of Corporate Affairs (MCA).",
            },
            {
              icon: <FaHandshake className="text-2xl" />,
              title: "Avoid Penalties",
              description: "Our services ensure all filings are completed within the mandatory 15-day deadline to help you avoid late fees and legal consequences.",
            },
            {
              icon: <FaRegCalendarCheck className="text-2xl" />,
              title: "End-to-End Compliance",
              description: "We provide comprehensive support, including document collection, compliance checks, and follow-up until the process is complete.",
            },
          ]}

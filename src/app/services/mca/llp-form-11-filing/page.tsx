      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        <div>
          <StartupHero
            heading={
              <>
                <span className={styles.coloredplc}>LLP Form 11 Filing</span>
                <span className={styles.coloredreg}> & Annual Return</span>
                <span style={{ letterSpacing: 'normal' }}> with </span>
                <span className={styles.colored}>Delfyle</span>
              </>
            }
            description="A Limited Liability Partnership (LLP) must file its Annual Return (Form 11) with the Ministry of Corporate Affairs (MCA) every year. Our expert services ensure your filing is accurate and submitted on time to maintain compliance and avoid penalties."
        />
          ...
          <ListComponent />
            ...
            <CustomAccordion
              subheading="Why Choose Delfyle for LLP Annual Return Filing?"
              title="Seamless LLP Form 11 Filing"
              description="At Delfyle, we offer expert assistance to ensure your LLP’s Annual Return is filed correctly and on time. Our team provides a comprehensive service to streamline the filing process, so you can focus on your business."
              items={[
                {
                  id: 'llp-filing-1',
                  title: 'Expert Guidance',
                  content: 'Our team of specialists ensures that your LLP remains fully compliant with all the regulatory requirements.',
                  stepNumber: 1
                },
                {
                  id: 'llp-filing-2',
                  title: 'Easy Process',
                  content: 'We simplify the filing process with a user-friendly platform and step-by-step guidance, making compliance effortless for you.',
                  stepNumber: 2
                },
                {
                  id: 'llp-filing-3',
                  title: 'Timely Filing',
                  content: 'We ensure your LLP Form 11 is submitted well before the deadline to help you avoid penalties.',
                  stepNumber: 3
                },
                {
                  id: 'llp-filing-4',
                  title: 'Accuracy',
                  content: 'Delfyle ensures all details are accurate and verified, avoiding any issues during the filing process.',
                  stepNumber: 4
                },
                {
                  id: 'llp-filing-5',
                  title: 'Comprehensive Support',
                  content: 'From document preparation to the final submission, we provide end-to-end assistance for all your filing needs.',
                  stepNumber: 5
                },
                {
                  id: 'llp-filing-6',
                  title: 'Compliance Monitoring',
                  content: 'Beyond Form 11, we help you stay on top of other ongoing LLP compliance requirements.',
                  stepNumber: 6
                }
              ]}
              variant="numbered"
         ...
         <CallToAction
            heading="Simplify Your LLP Form 11 Filing"
            highlighted="Ensure Timely & Accurate Submission"
            subheading="Don't risk the daily penalty of ₹100 for late filing. We ensure your LLP Annual Return is submitted accurately before the May 31st deadline."
            cards={[
              {
                icon: <FaFileCircleCheck className="text-2xl" />,
                title: "Expert Filing",
                description: "Our specialists handle the complete filing process, from preparing documents to submitting Form 11 and Form 8 with the MCA.",
              },
              {
                icon: <FaHandshake className="text-2xl" />,
                title: "Penalty-Free Compliance",
                description: "We guarantee timely submission to help you avoid the accumulating late fee of ₹100 per day.",
              },
              {
                icon: <FaRegCalendarCheck className="text-2xl" />,
                title: "End-to-End Support",
                description: "From pre-filing requirements like eForm 4 to obtaining DSCs, we provide comprehensive support for a hassle-free experience.",
              },
            ]}

  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>LLP Form 11 Filing</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely LLP form 11 filing with Delfyle's expert assistance. We handle all compliance requirements, including LLP form 11 filing, return filing, and compliance monitoring."
          buttonText="Get LLP Form 11 Filing Help"
          />

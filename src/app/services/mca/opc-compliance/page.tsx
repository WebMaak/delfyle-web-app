  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>OPC Compliance</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely OPC compliance with Delfyle's expert assistance. We handle all compliance requirements, including OPC compliance, return filing, and compliance monitoring."
          buttonText="Get OPC Compliance Help"
          />

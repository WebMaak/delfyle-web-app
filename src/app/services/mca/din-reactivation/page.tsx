  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>DIN Reactivation</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely DIN reactivation with Delfyle's expert assistance. We handle all compliance requirements, including DIN reactivation, return filing, and compliance monitoring."
          buttonText="Get DIN Reactivation Help"
          />

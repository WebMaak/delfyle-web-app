      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        <div>
          <StartupHero
            heading={
              <>
                <span className={styles.coloredplc}>Dormant Company</span>
                <span className={styles.coloredreg}> Status Filing</span>
                <span style={{ letterSpacing: 'normal' }}> with </span>
                <span className={styles.colored}>Delfyle</span>
              </>
            }
            description="A dormant company is an inactive entity that holds assets or intellectual property without significant business operations. Filing for dormant status reduces compliance requirements, making it a cost-effective way to maintain your company's legal existence for future use."
          />
         ...
         <CallToAction
          heading="Simplify Your Dormant Status Filing"
          highlighted="Ensure Smooth & Compliant Transition"
          subheading="Converting your company to dormant status helps you preserve its name and intellectual property without the full burden of active compliance. We make the process simple and hassle-free."
          cards={[
            {
              icon: <FaFileCircleCheck className="text-2xl" />,
              title: "Expert Guidance",
              description: "Our experts guide you through the entire process, from preparing the required board resolution to filing Form MSC-1 with the Registrar.",
            },
            {
              icon: <FaHandshake className="text-2xl" />,
              title: "Reduced Compliance",
              description: "We help you transition to a status that significantly reduces your annual compliance obligations and associated costs.",
            },
            {
              icon: <FaRegCalendarCheck className="text-2xl" />,
              title: "End-to-End Support",
              description: "We handle all necessary paperwork and filings, ensuring your dormant company remains in good standing with the Registrar.",
            },
          ]}

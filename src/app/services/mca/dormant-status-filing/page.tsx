  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Dormant Status Filing</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely dormant status filing with Delfyle's expert assistance. We handle all compliance requirements, including dormant status filing, return filing, and compliance monitoring."
          buttonText="Get Dormant Status Filing Help"
          />

  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Name Change Company</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely name change company with Delfyle's expert assistance. We handle all compliance requirements, including name change company, return filing, and compliance monitoring."
          buttonText="Get Name Change Company Help"
          />

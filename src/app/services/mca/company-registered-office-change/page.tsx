  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Company Registered Office Change</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely company registered office change with Delfyle's expert assistance. We handle all compliance requirements, including company registered office change, return filing, and compliance monitoring."
          buttonText="Get Company Registered Office Change Help"
          />

  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Remove Director</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely remove director with Delfyle's expert assistance. We handle all compliance requirements, including remove director, return filing, and compliance monitoring."
          buttonText="Get Remove Director Help"
          />

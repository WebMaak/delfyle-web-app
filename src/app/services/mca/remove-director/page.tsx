  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        <div>
          ...
          <StartupHero
              heading={
                <>
                  <span className={styles.coloredplc}>Director Removal</span>
              ...
              description="Navigate the complex process of removing a director with our expert assistance. We handle voluntary resignations and formal removals, ensuring full compliance and a smooth transition."
          />
         ...
         <CustomAccordion
          subheading="Why Choose Delfyle for Director Removal Services?"
          title="Trust Delfyle for a Smooth Process"
          description="Partnering with Delfyle for director removal ensures a seamless, fully compliant, and professionally managed process:"
          items={[
            {
              id: 'director-removal-1',
              title: 'Expert Legal Support',
              content: 'We provide an in-depth understanding of the Companies Act, 2013, ensuring your director removal is handled with complete legal accuracy.',
            },
            {
              id: 'director-removal-2',
              title: 'Regulatory Compliance',
              content: 'Our team ensures accurate preparation and timely filing of all necessary documents with the Registrar of Companies (ROC) to avoid penalties.',
            },
            {
              id: 'director-removal-3',
              title: 'Complete Assistance',
              content: 'We offer end-to-end support, from drafting the required board and shareholder resolutions to the final submission of Form DIR-12.',
            },
            {
              id: 'director-removal-4',
              title: 'Tailored Services',
              content: 'We provide customized support based on your company’s unique situation, whether it\'s a voluntary resignation or a removal due to non-compliance.',
            },
          ]}
          variant="numbered"
          theme="light"
      ...
      />
          ...
          <CallToAction
            heading="Ensure a Smooth Director Transition"
            highlighted="Legal & Compliant Director Removal"
            subheading="Whether by resignation or formal removal, our experts ensure your company's director change is legally sound and hassle-free."
            cards={[
              {
                icon: <FaUserMinus className="text-2xl" />,
                title: "Expert Legal Support",
                description: "We handle the entire process according to the Companies Act, 2013, to prevent legal issues.",
              },
              {
                icon: <FaFileInvoice className="text-2xl" />,
                title: "Complete Documentation & Filing",
                description: "Our team prepares all resolutions and filings, including Forms DIR-11 and DIR-12, for timely submission.",
              },
              {
                icon: <FaRegAddressCard className="text-2xl" />,
                title: "Hassle-Free Process",
                description: "We manage all formalities, allowing you to focus on your business without worrying about compliance.",
              },
            ]}

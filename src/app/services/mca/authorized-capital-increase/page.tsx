  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Authorized Capital Increase</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely authorized capital increase with Delfyle's expert assistance. We handle all compliance requirements, including authorized capital increase, return filing, and compliance monitoring."
          buttonText="Get Authorized Capital Increase Help"
          />

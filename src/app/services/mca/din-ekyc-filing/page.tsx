  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>DIN EKYC Filing</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely DIN EKYC filing with Delfyle's expert assistance. We handle all compliance requirements, including DIN EKYC filing, return filing, and compliance monitoring."
          buttonText="Get DIN EKYC Filing Help"
          />

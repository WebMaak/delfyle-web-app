    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        ...
        <StartupHero
            heading={
              <>
                <span className={styles.coloredplc}>DIN eKYC</span>
                <span className={styles.coloredreg}> Filing</span>
                <span style={{ letterSpacing: 'normal' }}> with </span>
                <span className={styles.colored}>Delfyle</span>
              </>
            }
            description="Ensure timely and accurate DIN eKYC filing with our expert assistance. We provide end-to-end support to keep your director status active and compliant with MCA rules."
        />
         ...
         <CustomAccordion
          subheading="Why Choose Delfyle for Your DIN eKYC Filing?"
          title="Your Partner for Stress-Free DIN eKYC Filing"
          description="At Delfyle, we streamline your DIN compliance process with end-to-end support."
          items={[
            {
              id: 'dinkyc-benefit-1',
              title: 'Expert Filing Support',
              content: 'We help you accurately complete Form DIR-3 KYC with up-to-date details, ensuring full compliance with MCA regulations.',
              stepNumber: 1
            },
            {
              id: 'dinkyc-benefit-2',
              title: 'DIN Status Check & Reactivation',
              content: 'If your DIN is deactivated, Delfyle assists with reactivation, including form preparation and late fee payment.',
              stepNumber: 2
            },
            {
              id: 'dinkyc-benefit-3',
              title: 'End-to-End Guidance',
              content: 'From downloading the correct form to digital signing, we ensure every detail is accurate and error-free.',
              stepNumber: 3
            },
            {
              id: 'dinkyc-benefit-4',
              title: 'Document Preparation',
              content: 'Our experts assist in compiling, verifying, and attaching all necessary documents for smooth submission.',
              stepNumber: 4
            },
            {
              id: 'dinkyc-benefit-5',
              title: 'Contact Verification Assistance',
              content: 'We guide you through OTP verification of your mobile number and email ID for form approval.',
              stepNumber: 5
            },
            {
              id: 'dinkyc-benefit-6',
              title: 'Submission and Acknowledgment Tracking',
              content: 'We handle the filing process on the MCA portal and help you track the SRN (Service Request Number) and acknowledgment email.',
              stepNumber: 6
            },
            {
              id: 'dinkyc-benefit-7',
              title: 'Annual Reminder & Support',
              content: 'Delfyle sends timely alerts so you never miss a filing deadline in the future. We also assist with the DIR-3 KYC web form for annual compliance.',
              stepNumber: 7
            }
          ]}
          variant="numbered"
          ...
          <CallToAction
            heading="Complete Your DIN eKYC Filing"
            highlighted="Ensure Your Director Status Remains Active"
            subheading="Let our experts handle your DIN eKYC filing and stay compliant with MCA regulations. Avoid penalties and DIN deactivation."
            cards={[
              {
              ...
              },
              {
                ...
                description: "If your DIN is deactivated, we manage the entire reactivation process, including form submission and penalty payments.",
              },
              {
                icon: <FaChartLine className="text-2xl" />,
                title: "Annual Compliance",
                description: "We provide timely reminders and support for both DIR-3 KYC e-Form and Web Form filings, so you never miss a deadline.",
              },
            ]}

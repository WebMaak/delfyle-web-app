      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        <div>
          <StartupHero
            heading={
              <>
                <span className={styles.coloredplc}>Demat of Shares</span>
                <span className={styles.coloredreg}> Services with</span>
                <span style={{ letterSpacing: 'normal' }}> </span>
                <span className={styles.colored}>Delfyle</span>
              </>
            }
            description="Convert your physical share certificates into secure electronic format. Our expert team ensures a smooth and compliant dematerialisation process, protecting your investments and simplifying transactions."
          />
         ...
         <CallToAction
          ...
          highlighted="Simplify Share Dematerialisation"
          subheading="From assisting with Demat account opening to handling RTA filings and post-compliance, we offer a comprehensive solution to help you meet the latest MCA regulations."
          cards={[
            {
              icon: <FaFileCircleCheck className="text-2xl" />,
              title: "Mandatory Compliance",
              description: "Adhere to the mandatory dematerialisation rules (Rule 9B) for private limited companies with our streamlined service.",
            },
            {
              icon: <FaHandshake className="text-2xl" />,
              title: "Enhanced Security",
              description: "Eliminate risks of loss, theft, or forgery associated with physical certificates by holding shares electronically.",
            },
            {
              icon: <FaRegCalendarCheck className="text-2xl" />,
              title: "Hassle-Free Process",
              description: "We handle all the paperwork and coordination, making the transition from physical to Demat effortless.",
            },
          ]}

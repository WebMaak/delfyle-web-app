  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Demat of Shares</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely demat of shares with Delfyle's expert assistance. We handle all compliance requirements, including demat of shares, return filing, and compliance monitoring."
          buttonText="Get Demat of Shares Help"
          />

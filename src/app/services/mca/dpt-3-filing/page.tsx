      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        <div>
          <StartupHero
            heading={
              <>
                <span className={styles.coloredplc}>DPT-3 Filing</span>
            ...
            description="Ensure your company is compliant with annual DPT-3 filing. Our expert services simplify the process of disclosing deposits, loans, and other financial transactions to the MCA, helping you meet the June 30th deadline."
        />
         ...
         <CallToAction
          heading="Simplify Your Annual DPT-3 Filing"
          highlighted="Ensure Timely and Accurate DPT-3 Submission"
          subheading="Don't risk penalties for non-compliance. We ensure the timely and accurate filing of Form DPT-3, helping you fulfill this annual regulatory requirement."
          cards={[
            {
              icon: <FaFileCircleCheck className="text-2xl" />,
              title: "Expert DPT-3 Filing",
              description: "We handle the entire process, from preparing the required auditor's certificate to e-filing the form with the Ministry of Corporate Affairs (MCA).",
            },
            {
              icon: <FaHandshake className="text-2xl" />,
              title: "Avoid Penalties",
              description: "Our services ensure all filings are completed before the June 30th deadline to help you avoid late fees and legal consequences.",
            },
            {
              icon: <FaRegCalendarCheck className="text-2xl" />,
              title: "End-to-End Compliance",
              description: "We provide comprehensive support, including data collection, verification, and follow-up until the process is complete.",
            },
          ]}

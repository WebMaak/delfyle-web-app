  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>DPT 3 Filing</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely DPT 3 filing with Delfyle's expert assistance. We handle all compliance requirements, including DPT 3 filing, return filing, and compliance monitoring."
          buttonText="Get DPT 3 Filing Help"
          />

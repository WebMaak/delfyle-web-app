      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        <div>
          <StartupHero
            heading={
              <>
                <span className={styles.coloredplc}>AOA Amendment</span>
            ...
            description="The Articles of Association (AOA) are the internal rules of your company. We help you amend them to reflect changes in your business, ensuring your internal governance is legally sound and up-to-date."
          />
          ...
          <CustomAccordion
            subheading="Why Choose Delfyle for AOA Amendment?"
            title="Seamless AOA Amendment Services"
            description="At Delfyle, we offer end-to-end AOA Amendment services tailored for your business needs."
            items={[
              {
                id: 'aoa-amendment-1',
                title: 'Expert Legal Drafting',
                content: 'We draft precise resolutions and the revised AOA to ensure they meet all legal requirements.',
                stepNumber: 1
              },
              {
                id: 'aoa-amendment-2',
                title: 'Compliance Checks',
                content: 'Our team conducts thorough checks to ensure the amendment is fully compliant with the Companies Act.',
                stepNumber: 2
              },
              {
                id: 'aoa-amendment-3',
                title: 'Filing Support',
                content: 'We handle the complete filing process, including Form MGT-14 and all other required ROC documentation.',
                stepNumber: 3
              },
              {
                id: 'aoa-amendment-4',
                title: 'Timely Execution',
                content: 'Our streamlined process ensures that your amendment is executed and filed in a timely manner to avoid penalties or rejections.',
                stepNumber: 4
              }
            ]}
            variant="numbered"
         ...
         <CallToAction
          heading="Update Your Company's Internal Rules"
          highlighted="Expert AOA Amendment for Seamless Governance"
          subheading="From changing shareholder rights to restructuring your board, our experts provide end-to-end support for a hassle-free and compliant AOA amendment process."
          cards={[
            {
              icon: <FaFileCircleCheck className="text-2xl" />,
              title: "Legal Compliance",
              description: "We ensure your AOA amendment adheres to the Companies Act, 2013, preventing legal issues and future complications.",
            },
            {
              icon: <FaHandshake className="text-2xl" />,
              title: "Efficient & Timely",
              description: "Our streamlined process ensures quick and accurate filing of Form MGT-14 and other documents to avoid delays and penalties.",
            },
            {
              icon: <FaRegCalendarCheck className="text-2xl" />,
              title: "Expert Guidance",
              description: "Receive professional advice on how to structure your AOA amendments to best serve your company's evolving needs.",
            },
          ]}

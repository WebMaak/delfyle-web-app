  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>LLP Compliance</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely LLP compliance with Delfyle's expert assistance. We handle all compliance requirements, including LLP compliance, return filing, and compliance monitoring."
          buttonText="Get LLP Compliance Help"
          />

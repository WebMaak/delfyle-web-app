    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        ...
        <StartupHero
          heading={
            <>
              <span className={styles.coloredplc}>Company</span>
          ...
          description="Simplify corporate compliance for your Private Limited Company. We guide you from incorporation to annual filings, ensuring you meet all legal requirements without hassle."
        />

  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Company Compliance</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely company compliance with Delfyle's expert assistance. We handle all compliance requirements, including company compliance, return filing, and compliance monitoring."
          buttonText="Get Company Compliance Help"
          />

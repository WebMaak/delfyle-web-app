    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        <div>
         ...
         <CallToAction
          heading="Ensure a Smooth Company Closure"
          highlighted="Navigate Liquidation with Confidence"
          subheading="Whether it's a voluntary closure or a Tribunal-initiated process, our team handles all legal formalities and documentation to ensure a smooth and compliant dissolution under the Companies Act and IBC."
          cards={[
            {
            ...
            },
            {
              ...
              description: "Ensure adherence to the Companies Act, 2013, and IBC, 2016, with our expert guidance.",
            },
            {
              icon: <FaRegCalendarCheck className="text-2xl" />,
              title: "End-to-End Support",
              description: "We manage all formalities, from drafting board resolutions to coordinating with the Tribunal.",
            },
          ]}

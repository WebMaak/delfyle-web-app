  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero
          heading={<><span>Winding Up Company</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely winding up company with Delfyle's expert assistance. We handle all compliance requirements, including winding up company, return filing, and compliance monitoring."
          buttonText="Get Winding Up Company Help"
          />

  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
          heading={<><span>Director Change</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
          description="Ensure timely director change with Delfyle's expert assistance. We handle all compliance requirements, including director change, return filing, and compliance monitoring."
          buttonText="Get Director Change Help"
          />

      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        <div>
         <StartupHero
            ...
            description="File your GSTR-9 annual return accurately and on time with Delfyle’s expert assistance. We handle everything from data consolidation to final submission, ensuring a hassle-free experience."
          />
          ...
          <CustomAccordion
            subheading="Why Choose Delfyle for GSTR-9 Filing?"
            title="Expert-Driven GSTR-9 Compliance"
            description="At Delfyle, we offer comprehensive, end-to-end support for your GSTR-9 annual return filing:"
            items={[
              {
                id: 'reason-1',
                title: 'Expert Assistance',
                content: 'Our services are managed by a team of experienced GST experts and certified Chartered Accountants to ensure maximum accuracy.',
                stepNumber: 1
              },
              {
                id: 'reason-2',
                title: 'Timely Compliance',
                content: 'We guarantee that you will never miss a filing deadline, helping you to avoid unnecessary penalties and late fees.',
                stepNumber: 2
              },
              {
                id: 'reason-3',
                title: 'Error-Free Filing',
                content: 'Our process includes thorough data validation and reconciliation to eliminate errors and ensure your filing is accurate.',
                stepNumber: 3
              },
              {
                id: 'reason-4',
                title: 'Complete Transparency',
                content: 'We provide step-by-step guidance and regular updates, keeping you fully informed throughout the entire filing process.',
                stepNumber: 4
              },
              {
                id: 'reason-5',
                title: 'Affordable Pricing',
                content: 'We offer customized solutions designed to fit your business size and specific needs, making compliance accessible and cost-effective.',
                stepNumber: 5
              }
            ]}
            variant="numbered"
          ...
          <CallToAction
            heading="Simplify Your Annual GST Return"
            highlighted="Filing with Delfyle"
            subheading="From data reconciliation to final submission, Delfyle ensures a seamless, accurate, and on-time GSTR-9 filing process."
            cards={[
              {
                icon: <FaUserTie className="text-2xl" />,
                title: "Expert Guidance",
                description: "Our process is managed by GST experts and CAs.",
              },
              {
                icon: <FaFileAlt className="text-2xl" />,
                title: "Error-Free Filing",
                description: "Automated data validation and reconciliation for accuracy.",
              },
              {
                icon: <FaBolt className="text-2xl" />,
                title: "Timely Compliance",
                description: "Never miss a deadline and avoid late filing penalties.",
              },
            ]}
            primaryBtnText="Start GSTR-9 Filing"

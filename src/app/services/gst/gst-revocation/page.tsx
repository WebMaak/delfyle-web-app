      ...
      <main id="smooth-content" className="relative min-h-screen bg-background text-foreground">
        <div>
          ...
          <StartupHero
            heading={
              <>
                <span className={styles.coloredplc}>GST Revocation</span>
                <span className={styles.coloredreg}> Assistance & Advisory</span>
                <span style={{ letterSpacing: 'normal' }}> from </span>
                <span className={styles.colored}>Delfyle</span>
              </>
            }
            description="Cancelled GST registration? Don't worry. Our experts at Delfyle provide complete guidance to assess your eligibility, prepare documentation, file the revocation application, and ensure smooth reinstatement of your GST registration."
          />
          ...
          <CallToAction
            heading="Cancelled GST Registration?"
            highlighted="Restore it with Ease"
            subheading="Our expert team provides end-to-end assistance, from assessing your eligibility to filing the revocation application, ensuring a smooth reinstatement of your GST registration."
            cards={[
              {
                icon: <FaUserTie className="text-2xl" />,
                title: "Eligibility Consultation",
                description: "We evaluate your GST cancellation case and guide you on your eligibility for revocation.",
              },
              {
                icon: <FaFileAlt className="text-2xl" />,
                title: "Document Preparation & Filing",
                description: "We help gather all required documents and file the GST revocation application accurately on your behalf.",
              },
              {
                icon: <FaBolt className="text-2xl" />,
                title: "Application Tracking/Follow-up",
                description: "Our experts track the application status and ensure timely follow-up with GST authorities until you receive the revocation order.",
              },
            ]}

      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
         ...
         <ListComponentReusable
            title="Required Documents for OPC Registration"
            description="Prepare and submit the following documents to the Registrar of Companies (ROC) for OPC registration:"
            listBlocks={[
              {
                items: [
                  "Memorandum of Association (MoA)",
                  "Articles of Association (AoA)",
                  "Nominee's consent, along with PAN card and Aadhaar card (Form INC-3)",
                  "Proof of Registered Office",
                  "Director's declaration (Form INC-9) and consent (Form DIR-2)",
                  "Declaration by a qualified professional certifying legal compliances",
                ],
                icon: FaCheckCircle, // Using a check icon for required documents

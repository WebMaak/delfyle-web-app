  ...
  return (
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
            heading={<><span>One Person Company (OPC)</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
            description="Register your OPC in India with Delfyle. Enjoy the benefits of a private limited company with a single owner."
            buttonText="Start Your OPC Registration"
          />

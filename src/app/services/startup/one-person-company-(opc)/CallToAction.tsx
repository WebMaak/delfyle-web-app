...
const CallToAction = () => {
  ...
  <h3 className="max-w-[60%] mx-auto text-xl md:text-2xl font-semibold text-gray-800 leading-snug mb-6">
    Register your One Person Company with Delfyle and enjoy seamless, professional support throughout the process!
  </h3>
  <p className="text-gray-600 max-w-2xl mx-auto mb-8 text-lg md:text-xl">
    Need help with OPC registration? Connect with our specialists for expert guidance and hassle-free incorporation.
  </p>
  ...
  <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-lg md:text-xl italic">
    Delfyle — Your Trusted Partner for Professional OPC Registration and Compliance.
  </p>
</section>

  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
            heading={<><span>Producer Company</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
            description="Register your Producer Company in India with Delfyle. Empower farmers and producers with a dedicated business structure."
            buttonText="Start Your Producer Company Registration"
          />

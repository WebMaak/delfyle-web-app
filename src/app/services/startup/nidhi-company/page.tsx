  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
            heading={<><span>Nidhi Company</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
            description="Register your Nidhi Company in India with Delfyle. Benefit from easy savings and lending among members with regulatory support."
            buttonText="Start Your Nidhi Registration"
          />

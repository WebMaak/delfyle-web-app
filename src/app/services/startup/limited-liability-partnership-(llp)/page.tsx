  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
            heading={<><span>Limited Liability Partnership (LLP)</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
            description="Register your LLP in India with expert guidance from Delfyle. Enjoy limited liability, flexible management, and a simple compliance structure."
            buttonText="Start Your LLP Registration"
          />

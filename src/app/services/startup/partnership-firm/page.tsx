  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
            heading={<><span>Partnership Firm</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
            description="Register your Partnership Firm in India with Delfyle. Get started with a simple and flexible business structure."
            buttonText="Start Your Partnership Registration"
          />

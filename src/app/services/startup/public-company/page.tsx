  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
            heading={<><span>Public Company</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
            description="Register your Public Company in India with Delfyle. Raise capital and expand your business with public participation."
            buttonText="Start Your Public Company Registration"
          />

  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
            heading={<><span>Trust Registration</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
            description="Register your Trust in India with Delfyle. Set up a legal entity for charitable or religious purposes with expert support."
            buttonText="Start Your Trust Registration"
          />

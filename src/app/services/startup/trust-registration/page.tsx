      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
            heading={
              <>
                <span className={styles.coloredplc}>Trust Registration </span>
            ...
            description="Register your Trust online with Delfyle’s expert assistance. From drafting the Trust Deed to compliance and approvals, we make the process simple and hassle-free."
          />
          ...
          <CallToAction
            ...
            highlighted="Trust Registration?"
            subheading="We make Trust registration simple with expert guidance, quick documentation, and complete compliance support to ensure your trust is legally sound and operational."
            cards={[
              {
                icon: <FaHandsHelping className="text-2xl" />,
                title: "Legal Compliance",
                description: "Complete assistance to ensure your trust meets all statutory requirements.",
              },
              {
                icon: <FaFileContract className="text-2xl" />,
                title: "Quick Documentation",
                description: "Drafting of trust deed and registration formalities made hassle-free.",
              },
              {
                icon: <FaBalanceScale className="text-2xl" />,
                title: "Trusted Guidance",
                description: "Expert advice on managing and operating the trust effectively.",
              },
            ]}
            primaryBtnText="Register Your Trust"

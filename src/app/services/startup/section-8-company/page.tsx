  ...
  return (
    ...
    <div id="smooth-wrapper" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <main id="smooth-content" className="min-h-screen">
        <div >
          <StartupHero 
            heading={<><span>Section 8 Company</span><br />with <span style={{color:'#FFD580'}}>Delfyle</span></>}
            description="Register your Section 8 Company in India with Delfyle. Promote charitable objectives with a not-for-profit company structure."
            buttonText="Start Your Section 8 Registration"
          />

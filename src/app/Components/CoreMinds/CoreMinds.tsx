...
const teamMembers = [
  ...
  },
  {
    ...
    quote:
      "Avinash Roy is a highly experienced Senior Tax Associate at Delfyle, specializing in both direct and indirect taxation. With over 6 years of in-depth experience, Avinash has successfully managed complex tax structures, assessments, and compliance strategies for startups, SMEs, corporates, and high-net-worth individuals.",
    bulletPoints: [
    ...
    <section ref={sectionRef} className={styles.section}>
      ...
      <div className={styles.header}>
        ...
        <p className={styles.description}>
          At Delfyle, we take pride in being more than just a legal and
          compliance consultancy—we're your extended team. Backed by
          professionals with deep expertise in law, finance, and corporate
          governance, our core team leads with precision, vision, and a shared
          passion for enabling entrepreneurial growth across India.
        </p>
      </div>
